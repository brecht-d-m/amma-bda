...
function initializeNotebookApplication(ipy, notebook, events, dialog, utils) {
    ...
    DataLabSession.prototype.execute = function(code, callback) {
        ...
        try {
            ...
            notebook.kernel.execute(code, callbacks, {
                silent: false,
                store_history: false
            });
        } catch (e) {
    ...
    require(['notebook/js/codecell'], function(ipy) {
        ...
        codeConfig.lineNumberFormatter = function(n) {
            return n.toString();
        };
    ...
    $('#renameButton').click(function() {
        notebook.save_widget.rename_notebook({
            notebook: notebook
        });
    })
...
function initializeNotebookList(ipy, notebookList, newNotebook, events, dialog, utils) {
    ...
    function addFolder(e) {
        notebookList.contents.new_untitled(notebookList.notebook_path || '', {
                type: 'directory'
            })
            .then(function() {
...
require(['base/js/namespace', 'base/js/events', 'base/js/dialog', 'base/js/utils', 'base/js/security', 'custom/datatonic'],
    initializeDataLab);
